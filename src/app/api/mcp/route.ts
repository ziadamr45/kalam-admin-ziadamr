  ...
  switch (method) {
    case "initialize": {
      ...
      return rpcResult(id, {
        ...
        instructions:
          "هذا الخادم يمنح 23 أداة سيادية تغطي كل أجزاء منصة «كلام له لازمة» بلا استثناء: إدارة المقالات والأقسام والأغلفة والتوليد الصوتي، رقابة التعليقات وتمييز الملهم منها وتحريره، إدارة القراء (حظر/فك حظر/منح وخصم رصيد الأثر والرتب)، قناة مقترحات أهل الكلمة، رسائل اتصل بنا، الصفحات القانونية، البث الجماهيري بإشعاراته الفورية وتحديثات المنصة، إعدادات الحوكمة وقائمة الفحص الأخلاقي، مركز الأمن (التنبيهات ومحاولات الاختراق وقواعد IP وسجل التدقيق)، النبض الحي للأحداث، التحليلات الشاملة، وإعادة توليد كاش الموقع فورًا. كل الأفعال تُوثّق في سجل التدقيق.",
      });
    }
