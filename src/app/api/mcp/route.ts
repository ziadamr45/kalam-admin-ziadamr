  ...
  switch (method) {
    case "initialize": {
      ...
      return rpcResult(id, {
        ...
        instructions:
          "هذا الخادم يمنح 32 أداة سيادية تغطي كل ذرة في منصة «كلام له لازمة» بلا استثناء — لا قراءة ولا تعديل خارج نطاق الأدوات: إدارة المقالات والأقسام (إنشاء وتعديل وحذف) والأغلفة والتوليد الصوتي، رقابة التعليقات وبلاغاتها وتمييز الملهم منها وتحريره، إدارة القراء (حظر/فك حظر/منح وخصم رصيد الأثر/تصفير الهوية/فحص وإبطال دخولاتهم)، دفتر الأثر الفكري نقطة بنقطة، ذرات التفاعل الخام (تصويتات ومشاركات ومحفوظات) مع إزالة أي سجل، بيانات القراءة الخام مع حق النسيان، حصص نقاش الذكاء الاصطناعي وتصفيرها، قناة مقترحات أهل الكلمة، رسائل اتصل بنا، الصفحات القانونية، البث الجماهيري وجرس الإشعارات الداخلي واشتراكات الإشعارات الفورية، سجل تحديثات المنصة، أخطاء المنصة المبلّغ عنها، إعدادات الحوكمة وقائمة الفحص الأخلاقي، مركز الأمن (التنبيهات ومحاولات الاختراق وقواعد IP وسجل التدقيق)، وحساب الإدارة نفسه (جلساته وأجهزته الموثوقة وكلمة مروره بالتحقق الحالي)، مع النبض الحي والتحليلات الشاملة وإعادة توليد كاش الموقع فورًا. كل الأفعال تُوثّق في سجل التدقيق.",
      });
    }
